...
/**
 * Service that will user validate on server side.
 */
...
public class OAuthGoogleUserService extends DefaultOAuth2UserService {
  ...
  public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
    ...
    return new AuthGoogleUser(user);
  }

  /**
   * Processing user on Google side. Will create user in table datasource.
   *
   * @param oauthUser default
   */
  public void processAuthPostLogin(DefaultOidcUser oauthUser) {
